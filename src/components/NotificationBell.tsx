...
export function NotificationBell() {
  ...
  const handleReactivate = async (notifId: string, tenantId: string) => {
    ...
    toast.success('✅ Parqueadero reactivado');
    queryClient.invalidateQueries({ queryKey: ['notifications'] });
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="Se eliminarán permanentemente todas las notificaciones. Esta acción no se puede deshacer."
        onConfirm={() => deleteAllNotifications.mutate()}
